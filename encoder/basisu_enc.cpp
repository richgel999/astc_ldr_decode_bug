...
#error TODO
	...
	// This ASTC specific texture format is readable using ARM's astcenc and AMD Compressonator. It doesn't support mipmaps.
	...
	{
		assert(pBlocks && block_width >= 4 && block_height >= 4 && dim_x & dim_y);
